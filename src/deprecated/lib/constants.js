 ...
 * Constantes heurísticas H×E×I: HAZARD_WEIGHTS, TYPE_FACTOR, HAZARD_LABELS, HORIZON, HORIZON_LABELS.
 * Ver: project-memory/CLEANUP_ANALYSIS.md — constants.js — DEPRECATE
 *
 * Este archivo es la copia de archivo de las constantes heurísticas frontend.
 * El wrapper en src/lib/constants.js re-exporta desde aquí.
