 ...
 * Duplicado frontend del modelo H×E×I: R = H×0.40 + E×0.30 + I_norm×0.30 — no validado.
 * Ver: project-memory/CLEANUP_ANALYSIS.md — riskEngine.js — DEPRECATE
 *
 * Este archivo es la copia de archivo de la lógica heurística frontend.
 * El wrapper en src/lib/riskEngine.js re-exporta desde aquí.
